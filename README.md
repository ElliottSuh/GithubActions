[![Run App <last name>, <first name>](https://github.com/ElliottSuh/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/ElliottSuh/GithubActions/actions/workflows/ci.yml)
